...
export type documentStorage = {
  ...
  instructions: [
    {
      name: "addDocument";
      discriminator: [199, 23, 223, 108, 14, 241, 149, 49];
      accounts: [
        {
          name: "userDocuments";
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [100, 111, 99, 117, 109, 101, 110, 116];
              },
              {
                kind: "account";
                path: "user";
    ...
    {
      name: "closeDocument";
      discriminator: [15, 249, 134, 244, 90, 126, 220, 237];
      accounts: [
        {
          name: "userDocuments";
          writable: true;
    ...
    {
      name: "shareDocument";
      discriminator: [21, 207, 234, 38, 150, 61, 192, 253];
      accounts: [
        {
          name: "document";
          writable: true;
  ...
  accounts: [
    ...
    {
      name: "userDocuments";
      discriminator: [121, 214, 242, 199, 91, 25, 103, 77];
    }
  ];
  errors: [
    {
