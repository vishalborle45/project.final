...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!solanaService) {
      setError(
        "Solana service is not available. Please reconnect your wallet."
      );
      return;
    }
    ...
    try {
      ...
      try {
        ...
        if (solError.toString().includes("already in use")) {
          ...
          toast.error(
            "Account created but failed to initialize Solana storage."
          );
        }
      }
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              ...
              className="w-full"
              disabled={
                loading || !connected || solanaLoading || !solanaService
              }
            >
              {loading
                ? "Creating account..."
